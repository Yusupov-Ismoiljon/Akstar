...
export default function MySwiperAyolar({ addCart1, addLike1, removeLike1, e }) {
    ...
    return (
        <div className='felx flex-col text-start w-full show text-white relative aos-init aos-animate rounded-lg' key={e.id}>
            ...
            <img className="w-full brightness-90 rounded-t-lg" style={{ objectFit: 'inherit', height: '350px' }} src={e.img} alt="new product" />
            <div className='p-3'>
                <div className="grow">
