...
export default function MySwiperAyolar({ addCart1, addLike, removeLike, e }) {
    ...
    return (
        <div className='felx flex-col text-start w-full show text-white relative aos-init aos-animate rounded-lg p-3' key={e.id}>
            ...
            <img className="w-full brightness-90 rounded-lg" style={{objectFit: 'inherit', height: '350px' }} src={e.img} alt="new product" />
            <div className="grow py-3 space-y-1">
