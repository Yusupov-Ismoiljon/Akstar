...
const MainWoman = ({ addCart1, addLike1, removeLike1, e }) => {
  ...
  return (
    ...
    <li
      ...
      data-aos-delay="100"
      data-aos="fade-up"
      className="w-full flex flex-col justify-between show text-white relative aos-init aos-animate rounded-lg"
    >
      <div>
        <img className="w-full h-72 rounded-lg brightness-90" src={e.img} alt="new product" />
        <button onClick={() => toggleLike(e.id)} className="absolute w-5 h-5 top-3 right-3 z-30">
