        ...
        <div className='md:flex md:items-center md:justify-between'>
          <div className='mb-5 md:mb-0 lg:mb-0 xl:mb-0'>
            <div className="lg:mb-0 mb-5 text-white">
              <h2 data-aos="fade-right" className="font-bold text-4xl mb-[30px] block aos-init aos-animate">Поступление новых товаров</h2>
            </div>
            <div>
              <p data-aos="fade-right" className='font-bold text-lg text-white aos-init aos-animate'>Новое изделие поступит на завод в течение 1 месяца.</p>
